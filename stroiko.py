...
with col_u1:
    ...
    st.write("Професионално полагане на фаянс, теракота, гранитогрес, цялостен ремонт на бани и мокри помещения.")

with col_u2:
    st.subheader("🎨 Шпакловка & Боя")
    st.write("Фина и груба шпакловка, шкурене, боядисване с латекс, отстраняване на влага и козметични ремонти.")
