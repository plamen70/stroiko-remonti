...
with col_u3:
    ...
    st.image(
        ...
        caption="Гипсокартон, окачени тавани и интериор",
        use_container_width=True
    )
...
# Примерни базисни цени за труд за кв.м.
prices = {
    "Лепене на плочки (фаянс/теракота)": 40,
    "Шпакловка + Боядисване": 18,
    "Монтаж на гипсокартон": 25,
    "Замазка / Подови настилки": 15
}
...
with col_c2:
    ...
    st.metric(label="Ориентировъчна сума за труд:", value=f"{total_price:.2f} лв.")
